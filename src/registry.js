...
import { AddItem, NewList, EditList, PartnerList, Share, Profile, Onboarding, ItemMenu, ListMenu } from './flows.jsx';
...
export const SCREENS = {
  ...
  AddItem, NewList, EditList, PartnerList, Share, Profile, Onboarding, ItemMenu, ListMenu,
